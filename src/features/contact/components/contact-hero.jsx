        ...
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-700 mb-16">
              Ready to transform your business with AI-driven solutions? Let's start the conversation.
            </p>
          </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative w-full bg-white rounded-full">
                    ...
                    >
                      ...
                      <option value="ai-applications">AI-Powered Applications</option>
                      <option value="automatepro">AutomatePro Platform</option>
                      <option value="regentcomply">Regentcomply.ai</option>
