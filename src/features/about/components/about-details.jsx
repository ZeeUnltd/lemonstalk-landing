        ...
        <div className="flex flex-wrap -mx-4 mb-24">
          ...
          <div className="w-full md:w-1/2 px-4">
            <div className="lg:max-w-lg md:ml-auto">
              ...
              <a className="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-teal-900 hover:text-lime-500 border border-lime-500 hover:border-teal-900 bg-lime-500 hover:bg-teal-900 rounded-full transition duration-300" href="/contact">
                Get in touch
              </a>
            </div>
          </div>
