 ...
 * @param {string} [props.companyName='Lemonstalk'] - Company name for copyright
...
const Footer = ({
  ...
  newsletter = {
    title: 'Stay Updated with Lemonstalk',
    description: 'Get the latest insights on AI-driven enterprise solutions, digital transformation strategies, and technology innovation.',
        ...
        <div className="flex flex-wrap mb-16 -mx-4">
          ...
          <div className="w-full lg:w-2/12 xl:w-2/12 px-4 mb-16 lg:mb-0">
            <Link className="inline-block mb-4" href="/">
              <Image
                src="/images/lemonstalk-logo-light.svg"
